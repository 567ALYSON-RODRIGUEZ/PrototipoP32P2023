...
public class MdiSeguridad extends javax.swing.JFrame {
    ...
    public MdiSeguridad() {
        ...
        this.setTitle("Alyson Vannesa Rodríguez Quezada 9959-21-829");
    ...
    private void initComponents() {
        ...
        mantenimientoTipoPersonas = new javax.swing.JCheckBoxMenuItem();
        ...
        mantenimientoTipoPersonas.setSelected(true);
        mantenimientoTipoPersonas.setText("Mantenimiento Tipo de Personas");
        mantenimientoTipoPersonas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mantenimientoTipoPersonasActionPerformed(evt);
            }
        });
        mnuCatalogosMantenimientos.add(mantenimientoTipoPersonas);
    ...
    private void mantenimientoTipoPersonasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mantenimientoTipoPersonasActionPerformed
        // TODO add your handling code here:
        frmMantenimientoPersonaTipo ventana = new frmMantenimientoPersonaTipo();
        jDesktopPane1.add(ventana);
        Dimension desktopSize = jDesktopPane1.getSize();
        Dimension FrameSize = ventana.getSize();
        ventana.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.             height) / 2);
    }//GEN-LAST:event_mantenimientoTipoPersonasActionPerformed
    ...
    private javax.swing.JCheckBoxMenuItem mantenimientoTipoPersonas;
