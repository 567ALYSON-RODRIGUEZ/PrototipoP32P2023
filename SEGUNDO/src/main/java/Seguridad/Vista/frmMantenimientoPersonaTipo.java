 ...
 * @author visitante
 */
public class frmMantenimientoPersonaTipo extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Estatus Persona");
       

        clsPersonaTipo persona = new clsPersonaTipo();
        //VendedorDAO vendedorDAO = new VendedorDAO();
        List<clsPersonaTipo> listapersona = persona.getListadoPersona();
     
        tablaPersonas.setModel(modelo);
        String[] dato = new String[10];
        for (int i = 0; i < listapersona.size(); i++) {
            dato[0] = Integer.toString(listapersona.get(i).getIdPersona());
            dato[1] = listapersona.get(i).getNombrePersona();
            dato[2] = listapersona.get(i).getEstatusPersona();
            modelo.addRow(dato);
        }       
    }

    public frmMantenimientoPersonaTipo() {
        initComponents();
        llenadoDeTablas();
        llenadoDeCombos();
    }
    ...
    private void initComponents() {
        ...
        tablaPersonas.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        clsPersonaTipo persona= new clsPersonaTipo();
        persona.setIdPersona(Integer.parseInt(txtbuscado.getText()));
        registrosBorrados=persona.setBorrarPersona(persona);

        JOptionPane.showMessageDialog(null, "Persona Borrado\n", 
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        clsPersonaTipo persona = new clsPersonaTipo();
        persona.setNombrePersona(txtNombre.getText());
        //modulos.setIdModulos(txtContrasena.getText());

        persona.setEstatusPersona(txtEstatus.getText());
        persona.setIngresarPersona(persona);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        persona.setIdPersona(Integer.parseInt(txtbuscado.getText()));        
        persona = persona.getBuscarInformacionPersonaPorId(persona);
        System.out.println("Persona retornado:" + persona);        
        txtNombre.setText(persona.getNombrePersona());
        //txtContrasena.setText(modulos.getIdModulos());
        txtEstatus.setText(persona.getEstatusPersona());
...
//        // TODO add your handling code here:
        ...
        persona.setModificarPersona(persona);
